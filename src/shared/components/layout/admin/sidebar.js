        ...
        <>
            <div id="sidebar-collapse" className="col-sm-3 col-lg-2 sidebar">
                ...
                <ul className="nav menu">
                    <li className={location.pathname==="/"?"active":""}><Link to="/"><svg className="glyph stroked dashboard-dial"><use xlinkHref="#stroked-dashboard-dial" /></svg> Dashboard</Link></li>
                    ...
                    <li className={location.pathname.includes("/contacts")?"active":""}><Link to="/contacts"><svg className="glyph stroked chain"><use xlinkHref="#stroked-chain" /></svg> Quản lý liên hệ</Link></li>
