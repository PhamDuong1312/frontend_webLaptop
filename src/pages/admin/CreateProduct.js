                            ...
                            <div className="panel-body">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select onChange={onChangeInputs} name="status" className="form-control">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <textarea onChange={onChangeInputs} required value={inputs.description||""} name="description" className="form-control" rows={3} defaultValue={""} />
                                    </div>
