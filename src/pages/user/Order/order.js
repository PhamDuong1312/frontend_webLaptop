                                    ...
                                    return (
                                        <div className="order_item">
                                            <div className="addressinfor">
                                                ...
                                                <p className="clearmagin">{item.fullname}</p>
                                                <p className="clearmagin">{item.phone}</p>
                                                <p className="clearmagin">{item.email}</p>
                                                <p className="clearmagin">{item.address}</p>
                                            </div>
                                            <div className="order_item_product">
                                                <Link to={`/product/${item.items[0].product._id}`} >
                                                    <img src={getImageProduct(item.items[0].product.image)} alt="anh" />
                                                </Link>
                                                <div className="order_item_body">
                                                    ...
                                                    {item.items[0].product.giamGia ? <>
                                                        <p className="order_item_price clearmagin" style={{ textDecoration: "line-through" }}>
                                                            {VND.format(item.items[0].product.price)}
                                                        </p>
                                                        <p className="order_item_price clearmagin " style={{ color: "red" }}>
                                                            {VND.format(item.items[0].product.price - item.items[0].product.price * item.items[0].product.giamGia / 100)}
                                                        </p>
                                                    </> : <p className="order_item_price clearmagin " style={{ color: "red" }}>
                                                        {VND.format(item.items[0].product.price - item.items[0].product.price * item.items[0].product.giamGia / 100)}
                                                    </p>
                                                        ...
                                                        return (
                                                            <div className="order_item_product">
                                                                <Link to={`/product/${product.product._id}`}>
                                                                    <img src={getImageProduct(product.product.image)} alt="anh" />
                                                                </Link>
                                                                <div className="order_item_body">
                                                                    <h6 className="order_item_name">
                                                                        <Link to={`/product/${product.product._id}`}>
                                                                    ...
                                                                    {product.product.giamGia ? <>
                                                                        <p className="order_item_price clearmagin" style={{ textDecoration: "line-through" }}>
                                                                            {VND.format(product.product.price)}
                                                                        </p>
                                                                        <p className="order_item_price clearmagin " style={{ color: "red" }}>
                                                                            {VND.format(product.product.price - product.product.price * product.product.giamGia / 100)}
                                                                        </p>
                                                                    </> : <p className="order_item_price clearmagin " style={{ color: "red" }}>
                                                                        {VND.format(product.product.price - product.product.price * product.product.giamGia / 100)}
                                                                    </p>
                                            ...
                                            <div className="totalprice">
                                                ...
                                                <p className="clearmagin" style={{ color: 'black' }}><b>Thành tiền : {VND.format(item.totalPrice)}</b></p>
                                            </div>
